...
public class Resource<T>
{
    ...
    public Resource(@NonNull int status, String errorType) {
        this.status = status;
    ...
    public static <T> Resource<T> error(String errorType)
    {
    ...
    public void attachErrorType(@NonNull String errorType)
    {
        this.errorType = errorType;
    }
