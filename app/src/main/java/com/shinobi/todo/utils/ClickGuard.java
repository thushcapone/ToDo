 ...
 * <p/>
 * Another way to guard a view is using a {@linkplain GuardedOnClickListener
 ...
 * <a href="https://github.com/fengdai/clickguard/blob/master/clickguard/src/main/java/clickguard/ClickGuard.java">
 * ClickGuard.java</a> and modified a little bit to respect my taste By ThushCapone on 09/01/2017
 */
public abstract class ClickGuard {
     ...
     */
    private static final long DEFAULT_WATCH_PERIOD_MILLIS = 600L;
    ...
    /**
     * Utility method. Use a new ClickGuard with default watch period {@link
    ...
    public static ClickGuard get(View view) {
        ...
        throw new IllegalStateException(
                "The view (id: 0x" + view.getId() + ") isn't guarded by ClickGuard!");
    }
    ...
    /**
     * Let the provided {@link OnClickListener} to be a {@link
     * GuardedOnClickListener}
    ...
    static abstract class ListenerGetter {
        ...
        private static class ListenerGetterBase extends ListenerGetter {
            ...
            ListenerGetterBase() {
                mOnClickListenerField = ReflectionUtils.getField(View.class, "mOnClickListener");
            }
            
            @Override
            public OnClickListener getOnClickListener(View view) {
                return (OnClickListener) ReflectionUtils.getFieldValue(mOnClickListenerField, view);
            }
        }
        ...
        private static class ListenerGetterIcs extends ListenerGetter {
            ...
            ListenerGetterIcs() {
                mListenerInfoField = ReflectionUtils.getField(View.class, "mListenerInfo");
                mListenerInfoField.setAccessible(true);
                mOnClickListenerField = ReflectionUtils.getField("android.view" +
                                                                         ".View$ListenerInfo",
                                                                 "mOnClickListener");
            }
            ...
            @Override
            public OnClickListener getOnClickListener(View view) {
                Object listenerInfo = ReflectionUtils.getFieldValue(mListenerInfoField, view);
                return listenerInfo != null ? ReflectionUtils.getFieldValue(mOnClickListenerField, listenerInfo)
                        : null;
            }
        }
    }
